...
def generate_practice_melodies_with_lyrics(practice_meolodies, treator:Treator):
...
def generate_practice_melodies(treator:Treator):
    practice_melodies = [
        {
            "title": "Simple_Scale",
            "notes": ['Do4', 'Re4', 'Mi4', 'Fa4', 'Sol4', 'Fa4', 'Mi4', 'Re4', 'Do4'],
    ...
    for melody in practice_melodies:
        print(f"Playing: {melody['title']}")
        generated_melody = treator._generate_melodie(
            melody['notes'],
            melody['durations'],
            melody['faddings'],
            melody['title'].lower()
        )
        treator._play_melodie(generated_melody)    
